...
// y retorna solo los tracks como un array de objetos solo con los datos que queremos
function extraerMusicas(datos) {
    // Primero scamos solo los tracks
    ...
    const respuesta = soloTracks.map(dato => ({
        id: dato.data.uri,
        name: dato.data.name,
...
function App() {
    ...
    function busquedaDeMusicas(buscar) {
        ...
        {/* Extraemos las musicas del archivo recibido y lo cargamos en listaDeResultados */}
        setListaDeResultados(extraerMusicas(datosParaPrueba));
